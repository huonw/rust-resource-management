window.addEventListener('load', function () {
    ...
    // titles shouldn't be links
    document.querySelectorAll("h1 > a").forEach(function(tag) {
    ...
    var found = window.location.hash.match(/^#([0-9]*)/)
    var current = (found !== null) ? Number.parseInt(found[1]) : 0;
